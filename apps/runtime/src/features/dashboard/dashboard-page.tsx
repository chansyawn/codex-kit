import { FileCogIcon, RefreshCwIcon, ServerIcon, TerminalSquareIcon } from "lucide-react";
  ...
  return (
    <section className="grid gap-5 py-4">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <SectionHeading title={m.dashboard_nav_dashboard()} detail={m.dashboard_detail()} />
